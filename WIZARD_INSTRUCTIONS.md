...
The Skills repository is automatically downloaded during the build process via `build.rs`:
...
4. Verifies Skills content is accessible
...
**Solution:**
1. Run `cargo build` to trigger automatic download
2. Manually clone: `git clone https://github.com/ComposioHQ/skills.git vendor/skills`
3. Verify path: `vendor/skills/skills/composio`
